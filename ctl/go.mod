...
require (
	...
	github.com/shiroyk/cloudcat/fetch v0.0.0-00010101000000-000000000000
	github.com/shiroyk/cloudcat/jsmodules v0.0.0-00010101000000-000000000000
	github.com/shiroyk/cloudcat/parsers v0.0.0-00010101000000-000000000000
