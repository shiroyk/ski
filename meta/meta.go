...
type Meta struct {
	Source *Source `yaml:"source" json:"source" toml:"source"`
	Config *Config `yaml:"config" json:"config" toml:"config"`
	Schema *Schema `yaml:"scheme" json:"schema" toml:"scheme"`
}
...
func (meta *Meta) UnmarshalTOML(data any) error {
	maps, _ := data.(map[string]any)
