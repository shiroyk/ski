...
import (
	js2 "github.com/shiroyk/cloudcat/core/js"
...
func runScript(ctx *plugin.Context, content any, script string) (any, error) {
	result, err := js2.Run(ctx, js2.Program{Code: script, Args: map[string]any{
		"content": content,
	}})
	if err != nil {
		return nil, err
