...
func (r *Request) prototype(rt *sobek.Runtime) *sobek.Object {
	...
	_ = p.Set("blob", r.blob)
	_ = p.SetSymbol(sobek.SymToStringTag, func(sobek.ConstructorCall) sobek.Value { return rt.ToValue("Request") })
	return p
}
