...
func init() {
	...
	js.Register("Blob", new(Blob))
	js.Register("Request", new(Request))
	js.Register("Response", new(Response))
	js.Register("ReadableStream", new(ReadableStream))
	js.Register("ReadableStreamBYOBReader", new(ReadableStreamBYOBReader))
	js.Register("ReadableStreamDefaultReader", new(ReadableStreamDefaultReader))
	js.Register("File", new(File))
	js.Register("URL", new(URL))
	js.Register("Headers", new(Headers))
